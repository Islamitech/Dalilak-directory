...
export const EGYPT_CITIES_BY_GOV: Record<string, string[]> = {
  'الجيزة': [
    'حدائق الأهرام (البوابة الأولى - خفرع)',
    'حدائق الأهرام (البوابة الثانية - خوفو)',
    'حدائق الأهرام (البوابة الثالثة - منقرع)',
    'حدائق الأهرام (البوابة الرابعة - مينا)',
    'منطقة أ (حدائق الأهرام)',
    'منطقة ب (حدائق الأهرام)',
    'منطقة ج (حدائق الأهرام)',
    'منطقة د (حدائق الأهرام)',
    'منطقة هـ (حدائق الأهرام)',
    'منطقة و (حدائق الأهرام)',
    'منطقة ز (حدائق الأهرام)',
    'منطقة ح (حدائق الأهرام)',
    'منطقة ط (حدائق الأهرام)',
    'منطقة ك (حدائق الأهرام)',
    'منطقة ل (حدائق الأهرام)',
    'منطقة م (حدائق الأهرام)',
    'منطقة ن (حدائق الأهرام)',
    'منطقة س (حدائق الأهرام)',
    'منطقة ص (حدائق الأهرام)',
    'منطقة ع (حدائق الأهرام)',
    'مدينة 6 أكتوبر (الأحياء 1 إلى 12)',
    'مدينة الشيخ زايد',
    'حدائق أكتوبر',
    'أكتوبر الجديدة',
    'شارع الهرم (العريش ومحيطها)',
    'شارع فيصل (العشرين، الطالبية، حسن محمد)',
    'المهندسين وشارع جامعة الدول',
    'الدقي وميدان المساحة',
    'العجوزة وكورنيش النيل',
    'ميدان الجيزة وشارع مراد والجامعة',
    'العمرانية (الغربية والشرقية)',
    'بولاق الدكرور وصفط اللبن',
    'إمبابة والوراق',
    'الرماية وهضبة الأهرام',
    'الحوامدية والبدرشين',
    'أبو النمرس وطموه والمنوات',
