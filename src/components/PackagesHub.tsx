...
export const PackagesHub: React.FC<PackagesHubProps> = ({
  ...
  const detailedPackages = [
    ...
    },
    {
      ...
      highlights: [
        ...
        'زيارة ميدانية وتصوير احترافي فائق الجودة لمقر المكان والبضائع',
      ...
      featuresIncluded: [
        ...
        { name: 'تدريب عملي خطوة بخطوة لصاحب المكان', desc: 'تعليمك كيفية إدارة الصفحات، الرد السريع، وعمل إعلانات ممولة ناجحة بنفسك.' },
        { name: 'دعم واستشارات يومية لمدة شهر كامل', desc: 'تواصل ومتابعة يومية للرد على أي استفسار وحل أي عقبات تسويقية فوراً.' },
        { name: 'إدارة التقييمات والرد على آراء الزبائن', desc: 'متابعة تقييمات العملاء على خرائط جوجل وحماية سمعة المنشأة والمحل.' },
    ...
    },
    {
      ...
      priceSubtext: 'تأسيس شامل للمشاريع والمحلات تحت التجهيز والإنشاء',
      isFlagship: true,
      badge: 'تاج التأسيس 🚀',
      ...
      accentColor: 'text-amber-500',
      summary: 'تكفل شامل من الصفر للمشاريع والمحلات تحت التجهيز والإنشاء: تصميم الهوية، اللافتة الخارجية، المطبوعات، تصوير سينمائي 4K، وحملة افتتاح ممولة.',
      ...
      highlights: [
        ...
        '🎬 تصوير فيديو إعلاني سينمائي بجودة 4K لمقر المشروع وتجهيزاته والافتتاح',
        ...
        '👨‍💼 تدريب صاحب المكان وفريق العمل على التشغيل والبيع الميداني'
      ],
      featuresIncluded: [
        ...
        { name: 'مرافقة ودعم مستمر لمدة 30 يوماً بعد الافتتاح', desc: 'فريق التسويق يرافقك شهراً كاملاً بعد الافتتاح لضمان ثبات المبيعات واستقرار المشروع.' }
      ],
      idealPractices: [
  ...
  const comparisonRows = [
    ...
    {
      feature: 'زيارة ميدانية وتصوير احترافي لمقر المكان',
      free: false,
      basic: false,
      pro: false,
      vip: 'تصوير فوتوغرافي',
  ...
  const getWhatsAppMessage = (pkg: typeof selectedPkg) => {
    return encodeURIComponent(
      `مرحباً دليلك 👋 أود الاستفسار والاشتراك في "${pkg.title}" بقيمة ${pkg.price === 0 ? 'الظهور المجاني' : `${pkg.price.toLocaleString('en-US')} جنيه مصري`} لمنشأتنا ومكاننا.`
    );
  };
