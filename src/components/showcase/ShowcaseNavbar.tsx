      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <button
            ...
            className="bg-amber-500 hover:bg-amber-400 text-slate-950 font-black text-xs px-3.5 sm:px-4 py-2.5 rounded-xl shadow-xs hover:shadow-sm flex items-center gap-1.5 transition-all active:scale-95 cursor-pointer shrink-0"
          >
